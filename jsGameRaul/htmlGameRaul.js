...
/*  formularioSalir.appendChild(returnBtn);  */ 
    ...
    if (parseInt(document.getElementById("resultado").dataset.resultado) == 6) {
        ...
        tituloFinal.appendChild(
            document.createTextNode("Has aconseguit una puntuació de " + puntuacion)
        );
